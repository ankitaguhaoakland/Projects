...
map4 <- get_map(location = c(lon = mean(eda2_States$longitude), lat = mean(eda2_States$latitude)), zoom = 4,
                      maptype = "satellite", scale = 2)
...
rm(pollutants1, pollutants1987, pollutants2, pollutants2017, map1, map1987, map2017, eda2_States, eda1, map4)
```
