...
Let's write the dataframe that we used here for our analysis, to another CSV File for continuing our next phase of analysis

```{r}
write.csv(eda_ozone, file = "eda_ozone.csv")
write.csv(mi_ozone, file = "mi_ozone.csv")
```
