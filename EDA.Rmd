...
***Proposition 1***
We would like to figure out which Test is mostly used for assessing the pollutants value across various regions based on latitude and longitude.
...
eda1 <- subset(eda, select = c(latitude, longitude, parameter_name, method_name, year, arithmetic_mean, arithmetic_standard_dev))
rm(eda)
```
